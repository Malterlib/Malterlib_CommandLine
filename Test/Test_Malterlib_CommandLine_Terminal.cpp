			...
			DMibTestSuite("General")
			{
				...
				for (int32 y = 2; y < 12 && !bTerminate; ++y)
				{
					...
					for (int32 x = 0; x < 20 && !bTerminate; ++x)
					{
						...
						//Surface.f_GradientHorizontal(TextDestination, {nullptr, {CTerminalColor::fs_FromRGBA(0, 0, 0), nullptr, nullptr}}, {nullptr, {CTerminalColor::fs_FromRGBA(255, 255, 255), nullptr, nullptr}});
						//Surface.f_GradientVertical(TextDestination, {nullptr, {CTerminalColor::fs_FromRGBA(0, 0, 0), nullptr, nullptr}}, {nullptr, {CTerminalColor::fs_FromRGBA(255, 255, 255), nullptr, nullptr}});
						//Surface.f_GradientHorizontal(TextDestination, {nullptr, {CTerminalColor::fs_FromRGBA(0, 128, 0), nullptr, nullptr}}, {nullptr, {CTerminalColor::fs_FromRGBA(128, 0, 128), nullptr, nullptr}});
						...
						Surface.f_Gradient
							(
								TextDestination
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = CTerminalColor::fs_FromRGBA(255, 0, 0), .m_ForegroundColor = nullptr, .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = CTerminalColor::fs_FromRGBA(0, 255, 0), .m_ForegroundColor = nullptr, .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = CTerminalColor::fs_FromRGBA(0, 0, 255), .m_ForegroundColor = nullptr, .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = CTerminalColor::fs_FromRGBA(255, 255, 0), .m_ForegroundColor = nullptr, .m_ChixelFlags = nullptr}}
							)
						;
						//Surface.f_GradientVertical(TextDestination, {nullptr, {CTerminalColor::fs_FromRGBA(0, 128, 0), nullptr, nullptr}}, {nullptr, {CTerminalColor::fs_FromRGBA(128, 0, 128), nullptr, nullptr}});
						...
						Surface.f_Gradient
							(
								TextBox
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = nullptr, .m_ForegroundColor = CTerminalColor::fs_FromRGBA(128, 128, 128), .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = nullptr, .m_ForegroundColor = CTerminalColor::fs_FromRGBA(255, 128, 128), .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = nullptr, .m_ForegroundColor = CTerminalColor::fs_FromRGBA(128, 255, 128), .m_ChixelFlags = nullptr}}
								, {.m_Character = nullptr, .m_Properties = {.m_BackgroundColor = nullptr, .m_ForegroundColor = CTerminalColor::fs_FromRGBA(128, 128, 255), .m_ChixelFlags = nullptr}}
							)
						;
...
/*						if (x == 0)
				...
				for (int32 y = Height / 10; (y < Height / 10 + 2) && !bTerminate; ++y)
				{
					...
					for (int32 x = (10); x < Width && !bTerminate; ++x)
					{
						...
						Surface.f_Text("Frame {fe0,sj4} fps    Render {fe0,sj4} fps    Draw {fe0,sj4} fps"_f << (fp64(1.0) / FrameTime) << (fp64(1.0) / LastRenderTime) << (fp64(1.0) / LastDrawTime), CTerminalSurface::CTextOptions());
