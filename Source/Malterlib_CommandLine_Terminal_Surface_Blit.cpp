...
namespace NMib::NCommandLine
{
	...
	{
		// Overlapping self-blits need a snapshot to avoid reading overwritten cells.
		if (&_Source == this)
		{
	...
	// Transparent source cells are skipped; transparent channels retain the destination color.
