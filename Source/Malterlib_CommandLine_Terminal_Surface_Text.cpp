						...
						_Change.f_Visit
							(
								[&]<typename tf_CType>(tf_CType const &_Change)
								{
									...
									{
										// Back to what the call started with, not to the destination cells:
										// the baseline is the text's default, and clearing the overrides
										// would leave later glyphs with whatever the cells held before
