...
namespace NMib::NCommandLine
{
	...
	void CAnsiEncodingParseInput::fp_DispatchCsi(CStrPtr const &_Params, char _Final)
	{
		...
		// The modifiers[:event] field also applies to legacy final-letter key forms.
		...
		switch (_Final)
		{
			case 'u':
			{
				...
				{
					// Without associated text, synthesize text only for presses/repeats without control-like modifiers.
					// Prefer the reported shifted codepoint for shifted strokes.
