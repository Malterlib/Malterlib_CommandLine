...
namespace NMib::NCommandLine
{
		...
		, mp_AnsiEncoding(_AnsiEncoding)
	{
		...
		// Cell indices use int32; compute the allocation size in a wider type to detect overflow.
	...
	// Returns nullptr when the cell has no combining-character overflow.
	...
	// Only valid while the cell has its overflow flag; overwritten entries can linger until f_Clear.
